...
public class ProductController {
    ...
    @GetMapping()
    public ResponseEntity<List<EntityModel<Product>>> fetchProduct(@RequestParam(required = false) String name,
    ...
    public ResponseEntity<EntityModel<Product>> fetchProductById(@PathVariable Long productId){
        ...
        return new ResponseEntity<>(productModelAssembler.toModel(productService.fetchById(productId)),HttpStatus.OK);
    }
    ...
    public ResponseEntity<EntityModel<Product>>  updateProductById(@PathVariable long productId,@Valid @RequestBody Product product){
        ...
        return new ResponseEntity(productModelAssembler.toModel(productService.updateProduct(productId,product)), HttpStatus.OK);
    }
}
